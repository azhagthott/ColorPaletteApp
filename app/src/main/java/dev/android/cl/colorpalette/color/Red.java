...
public class Red {
    ...
    public View allColorRed(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.red));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(context.getApplicationContext(), DetailScrollingActivity.class);
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.red_title);
