...
public class LightGreen {
    ...
    public View allColorLightGreen(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.light_green));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "light_green");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.light_green_title);
