...
public class Brown {
    ...
    public Brown(Context context) {
        this.context = context;
    }

    public View allColorBrown(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.brown));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "brown");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.brown_title);
