...
public class Orange {
    ...
    public View allColorOrange(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.orange));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "orange");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.orange_title);
