...
public class Amber {
    ...
    public Amber(Context context) {
        this.context = context;
    }

    public View allColorAmber(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.amber));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "amber");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.amber_title);
