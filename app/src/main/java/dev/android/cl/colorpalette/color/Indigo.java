...
public class Indigo {
    ...
    public Indigo(Context context) {
        this.context = context;
    }

    public View allColorIndigo(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.indigo));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "indigo");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.indigo_title);
