...
public class LightBlue {
    ...
    public LightBlue(Context context) {
        this.context = context;
    }

    public View allColorLightBlue(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.light_blue));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "light_blue");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.light_blue_title);
