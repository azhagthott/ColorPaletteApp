...
public class Grey {
    ...
    public View allColorGrey(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.grey));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "grey");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.grey_title);
