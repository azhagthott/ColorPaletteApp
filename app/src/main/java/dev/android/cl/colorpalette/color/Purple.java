...
public class Purple {
    ...
    public View allColorPurple(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.purple));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "purple");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.purple_title);
