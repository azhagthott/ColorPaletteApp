...
public class Green {
    ...
    public View allColorGreen(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.green));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "green");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.green_title);
