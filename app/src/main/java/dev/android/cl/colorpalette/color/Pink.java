...
public class Pink {
    ...
    public View allColorPink(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.pink));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "pink");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.pink_title);
