...
public class BlueGrey {
    ...
    public BlueGrey(Context context) {
        this.context = context;
    }

    public View allColorBlueGrey(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.blue_grey));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "blue_grey");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.blue_grey_title);
