...
public class Cyan {
    ...
    public Cyan(Context context) {
        this.context = context;
    }

    public View allColorCyan(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.cyan));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "cyan");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.cyan_title);
