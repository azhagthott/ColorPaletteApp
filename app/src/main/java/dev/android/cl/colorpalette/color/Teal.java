...
public class Teal {
    ...
    public Teal(Context context) {
        this.context = context;
    }

    public View allColorTeal(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.teal));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "teal");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.teal_title);
