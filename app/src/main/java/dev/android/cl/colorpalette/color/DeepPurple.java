...
import dev.android.cl.colorpalette.activity.DetailScrollingActivity;
...
public class DeepPurple {
    ...
    public DeepPurple(Context context) {
        this.context = context;
    }

    public View allColorDeepPurple(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.deep_purple));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "deep_purple");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.deep_purple_title);
