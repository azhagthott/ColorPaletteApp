...
public class Blue {
    ...
    public View allColorBlue(View view) {
        ...
        String[] allColor = getMaterialColorArray.getColorsValues(context, context.getResources().getString(R.string.blue));
            ...
            for (int j = 1; j <= 2; j++) {
                ...
                textColorHex.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("GROUP_COLOR_NAME", "blue");
    ...
    public View setTextViewColor(View view) {
        ...
        textView.setText(R.string.blue_title);
